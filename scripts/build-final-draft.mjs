...
const languages = {
  en: {
    ...
    storyLabel: "The artist", storyTitle: "PRAYZ is the person.<br>PRAYZVIBES is the name on the songs.",
    storyCopy: "Written independently. Built from voice and guitar. Shaped by road, landscape and encounter. The work stays close to what can be known—and leaves room for what cannot yet be named.",
  ...
  de: {
    ...
    storyLabel: "Der Künstler", storyTitle: "PRAYZ ist der Mensch.<br>PRAYZVIBES ist der Name auf den Songs.",
    storyCopy: "Unabhängig geschrieben. Aus Stimme und Gitarre gebaut. Geprägt von Wegen, Landschaft und Begegnung. Die Arbeit bleibt nah an dem, was wir wissen können – und lässt Raum für das, was sich noch nicht benennen lässt.",
  ...
  fr: {
    ...
    storyLabel: "L’artiste", storyTitle: "PRAYZ est la personne.<br>PRAYZVIBES est le nom sur les chansons.",
    storyCopy: "Écrit en toute indépendance. Construit avec une voix et une guitare. Façonné par la route, le paysage et la rencontre. Le travail reste proche de ce que nous pouvons savoir — et laisse une place à ce qui n’a pas encore de nom.",
