...
const languages = {
  en: {
    ...
    storyCopy: "That moment opened a self-taught path through different instruments and styles. The project began in a beautiful studio beneath the rafters and found its shape in the streets. From Franconian Switzerland, PRAYZ writes, performs and produces independently.",
  ...
  de: {
    ...
    storyCopy: "Dieser Moment öffnete einen autodidaktischen Weg durch verschiedene Instrumente und Stile. Das Projekt begann in einem wunderschönen Atelier im Dachstuhl und fand auf der Straße seine Form. In der Fränkischen Schweiz schreibt, spielt und produziert PRAYZ unabhängig.",
  ...
  fr: {
    ...
    storyCopy: "Ce moment a ouvert un parcours autodidacte à travers différents instruments et styles. Le projet a commencé dans un magnifique atelier sous la charpente avant de trouver sa forme dans la rue. Depuis la Suisse franconienne, PRAYZ écrit, interprète et produit en toute indépendance.",
